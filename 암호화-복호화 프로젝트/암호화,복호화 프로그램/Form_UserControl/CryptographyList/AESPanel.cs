...
{
    public partial class AESPanel : UserControl
    {
        long fileSize = 0;
        ...
        {
            InitializeComponent();
            AESEncryption.runEvent += SetProgressValue;
        }
        ...
        private void btnDecrypt_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                tbToText.Text = AESEncryption.Decrypt(tbFromText.Text, tbPassword.Text, tbIV.Text);
            }
            catch (Exception)
            {
        ...
        private void btnFileSave1_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == sfdFile.ShowDialog())
            {
                ...
                Task.Factory.StartNew(() => {
                    ...
                    AESEncryption.Encrypt(file, result, tbPassword.Text, tbIV.Text);
